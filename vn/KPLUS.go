...
func KPLUS(c *http.Client) model.Result {
	...
	firstRequestData, err := json.Marshal(map[string]any{
		...
		"deviceModel":      "Chrome",
		"deviceType":       "PC",
		"deviceSerial":     "w39db81c0-a2e9-11ed-952a-49b91c9e6f09",
		"deviceOem":        "Chrome",
		"devicePrettyName": "Chrome",
		"ssoToken":         ssoToken,
		"brand":            "vstv",
		"environment":      "p",
		"language":         "en_US",
	...
	resp, body, err := utils.PostJson(c, "https://tvapi-sgn.solocoo.tv/v1/session", string(firstRequestData), headers)
	if err != nil {
	...
	secondResp, secondBody, secondErr := utils.PostJson(c, "https://tvapi-sgn.solocoo.tv/v1/assets/BJO0h8jMwJWg5Id_4VLxIJ-VscUzRry_myp4aC21/play", secondRequestData, headers2)
	if secondErr != nil {
		return utils.HandleNetworkError(c, hostname, secondErr, name)
	}
